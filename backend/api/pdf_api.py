...
from services.pdf_service import filter_pages, create_pdf_with_pages
...
async def extract_keyword_pages(file: UploadFile = File(...)):
    ...
    # ค้นหาเลขหน้าจากไฟล์ใน memory
    # NOTE: ฟังก์ชัน filter_pages() และ create_pdf_with_pages() 
    # ต้องถูกแก้ไขให้รับ file-like object แทน path
